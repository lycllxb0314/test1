...
export const roleConfigs: Record<UserRole, RoleConfig> = {
  ...
  principal: {
    ...
    modules: ['general', 'academic', 'moral', 'teacher', 'parent', 'homepage'],
  ...
  secretary: {
    ...
    modules: ['general', 'moral', 'teacher', 'parent', 'homepage'],
    permissions: ['view', 'edit', 'approve', 'manage', 'admin'],
    avatar: '👨‍💼',
  },
  vice_principal: {
