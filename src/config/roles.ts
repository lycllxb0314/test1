...
export const roleConfigs: Record<UserRole, RoleConfig> = {
  ...
  principal: {
    ...
    modules: ['general', 'academic', 'moral', 'health', 'teacher'],
  ...
  secretary: {
    ...
    modules: ['general', 'moral', 'health', 'teacher'],
    permissions: ['view', 'edit', 'approve', 'manage', 'admin'],
    avatar: '👨‍💼',
  },
  academic_vice_principal: {
    ...
    modules: ['academic', 'health', 'teacher'],
  ...
  general_vice_principal: {
    ...
    modules: ['general', 'health', 'teacher'],
    permissions: ['view', 'edit', 'approve', 'manage'],
    avatar: '👨‍💼',
  },
